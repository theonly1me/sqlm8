...
export async function populateDB() {
  ...
  try {
    ...
    ('LETSS', 'Let', 'Jaime Yorres', 'Owner', '87 Polk St. Suite 5', 'San Francisco', 'CA', '94117', 'USA', '(415) 555-5938', NULL),
    ('LAMAI', 'La maison d', 'Annette Roulet', 'Sales Manager', '5 Rue Jouffroy D', 'Abbans', NULL, '25000', 'France', '03.03.03.03.03', '03.03.03.03.04'),
    ...
    ('LACOR', 'La corne d', 'Daniel Tonini', 'Sales Representative', '67 Bastille', 'Paris', NULL, '75012', 'France', '(1) 42.34.22.66', '(1) 42.34.22.77'),
    ...
    ('LINOD', 'LINO-Delicateses', 'Felipe Izquierdo', 'Owner', 'Ave. 5 de Mayo Porlamar', 'I. de Margarita', 'Nueva Esparta', '4980', 'Venezuela', '(8) 34-56-12', NULL),
    ...
    ('PRINI', 'Princesa Isabel Vinhoss', 'Isabel de Castro', 'Sales Representative', 'Estrada da saúde n. 58', 'Lisboa', NULL, '1756', 'Portugal', '(1) 356-5634', NULL),
    ...
    ('TRADH', 'Tradiçao Hipermercados', 'Anabela Domingues', 'Sales Representative', 'Av. Inês de Castro, 414', 'Sao Paulo', 'SP', '05634-030', 'Brazil', '(11) 555-2167', '(11) 555-2168'),
    ('TRAIH', 'Trail', 'Helvetius Nagy', 'Sales Associate', 'Kirchgasse 6', 'Graz', NULL, '8010', 'Austria', '7675-3425', '7675-3426'),
